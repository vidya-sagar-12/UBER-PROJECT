...
const FinishRide = (props) => {
  return (
    <div>
      <h5 onClick={()=>{props.setFinishRidePanel(false)}} className='p-1 text-center w-[93%] absolute top-0'><i className="text-3xl text-gray-500 ri-arrow-down-wide-line"></i></h5>
      ...
      <div className='w-full mt-5'>
        ...
        <div className='mt-10 w-full'>
            <Link to='/captain-home' className='w-full text-lg flex justify-center mt-5 bg-green-500 text-white font-semibold p-3 rounded-lg'>Finish Ride</Link>
        </div>
      </div>
    </div>
  )
